...
container_name="frontend"  # Update this to your container name with the tag
image_name="290672292276.dkr.ecr.ap-southeast-2.amazonaws.com/seguro_front_prod:latest"
